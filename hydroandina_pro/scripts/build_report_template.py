...
Genera hydroandina_pro/resources/plantilla_reporte.docx: la plantilla
...
plantilla:
    ...
    python-qgis.bat hydroandina_pro/scripts/build_report_template.py
...
def _agregar_portada(doc: Document):
    titulo = doc.add_heading("HydroAndina Pro — Reporte Técnico de Análisis Hidrológico e Hidráulico",
                              level=0)
    ...
    p3.add_run("Plugin HydroAndina Pro — motor hidrológico/hidráulico para cuencas andinas del Perú")
...
def construir_plantilla():
    ...
    doc.add_paragraph(
        "Este reporte fue generado automáticamente por el plugin HydroAndina Pro a partir de los "
